...
public class sumUTXO {
    ...
    public static void main(String[] args) throws Exception {
        ...
        long aggUTXOTime = Long.parseLong(args[9]); //oldFiles.sumUTXO only
        String log = args[17];
        ...
        consumerFromUTXO.subscribe(Collections.singletonList(input_topic),
                new ConsumerRebalanceListener() {
                    ...
                    public void onPartitionsAssigned(Collection<TopicPartition> partitions) {
                        ...
                        aggUTXO = new HashMap<String, Long>();
                        empty = true;
                        System.out.println("oldFiles.sumUTXO is rebalanced.");
                    }});
    ...
    private static void pollFromAccountInfo(Block recordValue, int i) {
        //Since no partition else simply collect all account info before, we have to poll much more data from
        //localBalance to know every account no. and its corresponding bank.
        //Though not essential, I use a new topic "accountInfo" just to make it easier.
        //It might also be useful if expanding new accounts is legal.
