...
public class Account extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 542518160867732471L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Account\",\"namespace\":\"my.avroSchema\",\"fields\":[{\"name\":\"AccountNo\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Account(java.lang.String AccountNo) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: AccountNo = value$ != null ? value$.toString() : null; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static my.avroSchema.Account.Builder newBuilder() {
    return new my.avroSchema.Account.Builder();
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static my.avroSchema.Account.Builder newBuilder(my.avroSchema.Account.Builder other) {
    if (other == null) {
      return new my.avroSchema.Account.Builder();
    } else {
      return new my.avroSchema.Account.Builder(other);
    }
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static my.avroSchema.Account.Builder newBuilder(my.avroSchema.Account other) {
    if (other == null) {
      return new my.avroSchema.Account.Builder();
    } else {
      return new my.avroSchema.Account.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Account>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(my.avroSchema.Account.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.AccountNo)) {
        this.AccountNo = data().deepCopy(fields()[0].schema(), other.AccountNo);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(my.avroSchema.Account other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.AccountNo)) {
        this.AccountNo = data().deepCopy(fields()[0].schema(), other.AccountNo);
    ...
    /**
      ...
      * @return This builder.
      */
    public my.avroSchema.Account.Builder setAccountNo(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public my.avroSchema.Account.Builder clearAccountNo() {
      AccountNo = null;
    ...
    public Account build() {
      try {
        ...
        record.AccountNo = fieldSetFlags()[0] ? this.AccountNo : (java.lang.String) defaultValue(fields()[0]);
        return record;
